...
public class DynamicShardingManager {
    ...
    private static final String LOGIC_TABLE_NAME_PREFIX = "yu_picture.";
    ...
    private void updateShardingTableNodes() {
        ...
        // yu_picture.picture_112321321, yu_picture.picture_1123213124
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> LOGIC_TABLE_NAME_PREFIX + tableName)
