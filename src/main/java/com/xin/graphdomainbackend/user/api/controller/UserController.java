package com.xin.graphdomainbackend.user.api.controller;
...
import com.xin.graphdomainbackend.user.api.dto.request.*;
...
import com.xin.graphdomainbackend.user.service.SignInService;
...
public class UserController {
    ...
    public BaseResponse<Boolean> getEmailCode(@RequestBody EmailCodeRequest emailCodeRequest, HttpServletRequest request) {
        ...
        // 检测高频操作
        crawlerService.detectFrequentRequest(request);
