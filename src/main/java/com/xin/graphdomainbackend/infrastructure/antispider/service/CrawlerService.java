package com.xin.graphdomainbackend.infrastructure.antispider.service;
...
public class CrawlerService {
    ...
    private void detectRequest(HttpServletRequest request, int warnCount, int banCount) {
        ...
        // 统计2分钟内的访问次数(150秒后过期)
        long count = counterService.incrAndGetCounter(key, 2, TimeUnit.MINUTES, CrawlerConstant.EXPIRE_TIME);
