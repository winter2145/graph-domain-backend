package com.xin.graphdomainbackend.category.service.impl;
...
import com.xin.graphdomainbackend.category.dao.mapper.CategoryMapper;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category>
    ...
    public Page<CategoryVO> getCategoryVOByPage(CategoryQueryRequest categoryQueryRequest) {
        ...
        // 分类名字不为空，添加分类条件
        lambdaQueryWrapper.eq(StringUtils.hasText(categoryName), Category::getCategoryName, categoryName);
    ...
    public Boolean addCategory(String categoryName) {
        ThrowUtils.throwIf(!StringUtils.hasText(categoryName), ErrorCode.PARAMS_ERROR, "分类名不能为空");
